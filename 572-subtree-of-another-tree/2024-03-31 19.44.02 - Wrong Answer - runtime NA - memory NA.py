...
class Solution:
    def isSubtree(self, root: Optional[TreeNode], subRoot: Optional[TreeNode]) -> bool:
        ...
        def recursiveCheck(root1, root2):
            ...
            print("Comparing:", root1.val, root2.val)
        ...
        def recursiveSearch(root1, root2):
            ...
            if root1.val == root2.val:
                ...
                isSubtree = recursiveCheck(root1, root2)

            #see if you can find node to match root in other subtrees
            recursiveSearch(root1.left, root2)
            recursiveSearch(root1.right, root2)
        recursiveSearch(root, subRoot)
        return isSubtree
